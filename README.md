# Ponerpics Custom Shortcuts

Custom Shortcuts is an userscript for the site [Ponerpics](https://ponerpics.org/), and enables the customization the site's original keyboard shortcuts and many additional functions, including a keyboard navigation mode.

## Installation
An userscript manager such as [Violentmonkey](https://violentmonkey.github.io/) is required.

[Click here to install](https://github.com/marktaiwan/Derpibooru-Custom-Shortcuts/raw/ponerpics/ponerpics-custom-shortcuts.user.js)
