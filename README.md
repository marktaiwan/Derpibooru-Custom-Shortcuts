...
## User guide
By default, the script makes no changes or additions to Twibooru's default shortcuts. Upon installation, users should open up the settings with `ctrl + shift + /` to begin customization.
